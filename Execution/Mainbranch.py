...
test.tablename = "testTable"  # changing the an attribute value
test.csvname = "test.csv"  # changing the an attribute value
ideal = Idealclass  # generating an object from the FromCSV class
ideal.tablename ="idealTable"  # changing the an attribute value
ideal.csvname = "ideal.csv"  # changing the an attribute value
train = Trainclass  # generating an object from the FromCSV class
train.tablename ="trainTable"  # changing the an attribute value
train.csvname = "train.csv"  # changing the an attribute value
...
minvalue_series = identifyideal(sqliteConnection, train.tablename, ideal.tablename) # identifies the matching ideal functions and plots the results
